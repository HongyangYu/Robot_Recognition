...
from keras.models import Sequentialen
from keras.layers.convolutional import Convolution2D, MaxPooling2D
from keras.optimizers import SGD
from keras.layers.core import Dense, Dropout, Activation, Flatt
...
( X_train, y_train ) = preprocess.readTrainingData( trainingFile )
